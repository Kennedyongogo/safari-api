...
module.exports = (sequelize) => {
  const TravellerGallery = sequelize.define(
    "TravellerGallery",
    {
      id: {
        type: DataTypes.UUID,
      ...
      filePath: {
        ...
        allowNull: false,
        comment:
          "Relative path to the uploaded file (e.g., uploads/traveller-gallery/filename.jpg)",
      },
      originalName: {
      ...
      category: {
        ...
        comment: "By Traveller category for organization",
      },
      tags: {
        type: DataTypes.JSON,
        allowNull: false,
      ...
      isActive: {
        ...
        allowNull: false,
        defaultValue: true,
        comment: "Whether the traveller gallery item is active/visible",
      },
      // Audit fields
      created_by: {
        type: DataTypes.UUID,
